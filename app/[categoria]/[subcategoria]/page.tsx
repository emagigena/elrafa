...
export default function CategoryPage({ params }: { params: { categoria: string; subcategoria: string } }) {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const q = query(productsRef, where("CATEGORÍA", "==", decodeURIComponent(subcategoria)))
  ...
  const isArmeria = subcategoria === "ARMERÍA"

  const categoryName = decodeURIComponent(subcategoria)
