        ...
        {compraTerminada ? (
          <Container>
            <div style={{ textAlign: "center", margin: "30px" }}>
              ...
              <h3>Pronto nos comunicaremos con usted para coordinar el envío a {dataFormulario.direccion}</h3>
          ...
          <Container className="my-4 bg-white text-center">
            {productosAgregados() === 0 ? (
              <div>
                ...
                <Button className="btn btn-success mx-2" onClick={() => navegar("/")}>
                  Inicio
                </Button>
              </div>
            ) : (
                    ...
                    <tbody>
                      {cartList.map((item) => (
                        <tr key={item.id}>
                          ...
                          <td></td> */}
                          <td>
                            <Button variant="danger" onClick={() => borrarItem(item.id)}>
                              Quitar
                            </Button>
                          </td>
                        </tr>
                ...
                <div className="formulario">
                  ...
                  <Form onSubmit={generarOrden}>
                    ...
                    <Container style={{ marginTop: "10px" }}>
                      {Object.values(dataFormulario).some((value) => value !== "") ? (
                        <IrWhatsapp cartList={cartList} dataFormulario={dataFormulario} generarOrden={generarOrden} />
                      ) : (
                        ""
                      )}
                    </Container>
                  ...
                  <Button onClick={() => navegar("/")} className="btn btn-primary">
                    Volver al Catálogo
                  </Button>
                </div>
              </div>
