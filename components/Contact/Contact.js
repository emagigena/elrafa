      ...
      {isMobile ? (
        <>
          <div style={{ marginTop: "40px" }}>
            <h1 className="text-2xl font-semibold text-black text-center">CONTACTÁ CON NOSOTROS</h1>

            <div className="bottom-textt-hours text-2xl font-bold text-black text-center">
              <h>Lun a Vie 8.30H a 12:30H - 16.30H 20.30H </h> <tr /> <h>Sab de 8:30H a 12:30H.</h>
            </div>
          </div>
                ...
                return (
                  <Col key={idx} className="col-lg-3">
                    <Card className="contact-card">
                      <Card.Img src={datosContacto.img[0]} style={{ objectFit: "contain" }} />
                      <Card.Body>
        ...
        <>
          <div style={{ marginTop: "40px" }}>
            ...
            <div className="bottom-textt-hours text-2xl font-bold text-black text-center">
              <p>Lun a Vie 8.30H a 12:30H - 16.30H 20.30H | Sab de 8:30H a 12:30H.</p>
            </div>
          </div>
          <div className="contact-container">
