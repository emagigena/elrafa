const productos = [
  {
    id: "1",
    nombre: "GUITARRA ACUSTICA EKO RANGER",
    precio: 1.999,
    CATEGORÍA: "EKO",
    marca: "EKO",
    stock: 15,
  ...
  {
    id: "2",
    nombre: "GUITARRA AC EKO RANGER FOLK12c",
    precio: 2.999,
    CATEGORÍA: "EKO",
    marca: "EKO",
    stock: 17,
    fotos: [
      ...
      {
        idfoto: 2,
        foto: "http://d3ugyf2ht6aenh.cloudfront.net/stores/001/312/585/products/eko571-4b44129a40bc51298e16376260737523-640-0.jpg",
      },
    ],
  },
  {
    id: "3",
    nombre: "GUITARRA ELEC DANELECTRO 59M",
    precio: 3.999,
    CATEGORÍA: "DANELECTRO",
    marca: "DANELECTRO",
    stock: 25,
    fotos: [
      ...
      {
        idfoto: 2,
        foto: "https://www.stringsfield.com/9395-medium_default/guitarra-electrica-danelectro-de-59m-nos-blk.jpg",
      },
    ],
  },
  {
    id: "4",
    nombre: "BAJO ELECTRICO TOKAI",
    precio: 3.999,
    CATEGORÍA: "TOKAI",
    marca: "TOKAI",
    stock: 25,
    fotos: [
      ...
      {
        idfoto: 2,
        foto: "https://img.kytary.com/eshop_at/stredni_v4x/na/637401220496030000/175b2ef8/64796256/tokai-1981-jazz-sound.jpg",
      },
    ],
  },
  {
    id: "5",
    nombre: "BAJO ELECTRICO LEONARD PARA ZURDOS",
    precio: 3.999,
    CATEGORÍA: "LEONARD",
    marca: "LEONARD",
    stock: 25,
  ...
  {
    id: "6",
    nombre: "BAJO ELECTRICO LEONARD PRECISION",
    precio: 3.999,
    CATEGORÍA: "LEONARD",
    marca: "LEONARD",
    stock: 25,
  ...
  {
    id: "7",
    nombre: "GUITARRA DANELECTRO CONV AC-ELEC",
    precio: 3.999,
    CATEGORÍA: "DANELECTRO",
    marca: "DANELECTRO",
    stock: 25,
  ...
  {
    id: "8",
    nombre: "GUITARRA ELÉCTRICA STAGG LES PAUL",
    precio: 3.999,
    CATEGORÍA: "STAGG",
    marca: "STAGG",
    stock: 25,
  ...
  {
    id: "9",
    nombre: "GUITARRA ELEC STAGG SILVERAY & RED",
    precio: 3.999,
    CATEGORÍA: "STAGG",
    marca: "STAGG",
    stock: 25,
  ...
  {
    id: "10",
    nombre: "GUITARRA ELEC STAGG TELECASTER",
    precio: 3.999,
    CATEGORÍA: "STAGG",
    marca: "STAGG",
    stock: 25,
  ...
  {
    id: "11",
    nombre: "GUITARRA ELECTRICA TOKAI TIPO 335",
    precio: 3.999,
    CATEGORÍA: "TOKAI",
    marca: "TOKAI",
    stock: 25,
  ...
  {
    id: "12",
    nombre: "GUITARRA ELECTRICA TOKAI LES PAUL",
    precio: 3.999,
    CATEGORÍA: "TOKAI",
    marca: "TOKAI",
    stock: 25,
