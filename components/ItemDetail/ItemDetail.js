          ...
          <Col>
            {producto > 0 ? (
              <div style={{ display: "flex", justifyContent: "center" }}>
                <Badge style={{ borderRadius: "0px", width: "31%" }}>EN STOCK</Badge>
                <Badge bg="success" style={{ borderRadius: "0px", width: "31%" }}>
                  ¡OFERTA!
                </Badge>
              </div>
            ) : (
          ...
          <Col>
            <div className="InfoContainer">
              ...
              {state ? (
                ...
                <Link to="/Cart">
                  <Button variant="none" className="btn" style={{ backgroundColor: "red", color: "white" }} size="lg">
                    Consultar
                  </Button>
                </Link>
              )}
