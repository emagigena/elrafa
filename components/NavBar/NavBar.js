      ...
      {isMobile ? (
        ...
        >
          <Nav style={{ justifyContent: "center" }}>
            <NavLink to="/CATEGORÍA/ARMERÍA" className="nav-link text-white w-10 text-center">
              <div className="nav-icon">
                <img src={armeria} alt="armeria" className="nav-icon-img" style={{ width: "50px", height: "50px" }} />
                <span className="nav-icon-label" style={{ color: "black", fontSize: "12px" }}>
                  <h style={{ fontWeight: 900 }}>ARMAS</h>
                </span>
              </div>
            </NavLink>
            <NavLink to="/CATEGORÍA/MUNICIONES" className="nav-link text-white w-10 text-center">
              <div className="nav-icon">
                <img
                  src={municiones}
                  alt="municiones"
            ...
            <NavLink to="/CATEGORÍA/NÁUTICA" className="nav-link text-white w-10 text-center">
              <div className="nav-icon">
                <img src={nautica} alt="nautica" className="nav-icon-img" style={{ width: "50px", height: "50px" }} />
                <span className="nav-icon-label" style={{ color: "black", fontSize: "12px" }}>
                  <h style={{ fontWeight: 900 }}>NÁUTICA</h>
                </span>
              </div>
            </NavLink>
            <NavLink to="/CATEGORÍA/PESCA" className="nav-link text-white w-10 text-center">
              <div className="nav-icon">
                <img src={pesca} alt="pesca" className="nav-icon-img" style={{ width: "50px", height: "50px" }} />
                <span className="nav-icon-label" style={{ color: "black", fontSize: "12px" }}>
        ...
        <Navbar collapseOnSelect expand="lg" bg="light" variant="light" className="ContainerNavbar">
          <Container>
            <NavLink to="/">
              <Image
                src={
