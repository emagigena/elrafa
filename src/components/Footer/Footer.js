    ...
    <footer className="Footer">
      ...
      <flex>
        <div className="footer-section">
          ...
          <div style={{ margin: "10px" }}>
            <a style={{color: "white"}} href="https://www.instagram.com/armeriaynauticaelrafa/">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="26"
                height="26"
          ...
          <div style={{ margin: "10px" }}>
          <a style={{color: "white"}} href="https://api.whatsapp.com/send/?phone=3425152705&text&type=phone_number&app_absent=0">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="26"
              height="26"
