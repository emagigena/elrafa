const productos = [
    {id: '1'  , nombre: 'GUITARRA ACUSTICA EKO RANGER' ,precio: 1.999, CATEGORÍA: "EKO" , marca: "EKO" , stock: 15, 
        fotos: [
    ...
    {id: '2'  , nombre: 'GUITARRA AC EKO RANGER FOLK12c' , precio: 2.999, CATEGORÍA: "EKO" , marca: "EKO" , stock: 17, fotos : [
    ...
    {id: '3'  , nombre: 'GUITARRA ELEC DANELECTRO 59M' , precio: 3.999, CATEGORÍA: "DANELECTRO" , marca: "DANELECTRO", stock: 25, fotos : [
    ...
    {id: '4'  , nombre: 'BAJO ELECTRICO TOKAI' , precio: 3.999, CATEGORÍA: "TOKAI" , marca: "TOKAI" , stock: 25, fotos : [
    ...
    {id: '5'  , nombre: 'BAJO ELECTRICO LEONARD PARA ZURDOS' , precio: 3.999, CATEGORÍA: "LEONARD" , marca: "LEONARD" , stock: 25, fotos : [
    ...
    {id: '6'  , nombre: 'BAJO ELECTRICO LEONARD PRECISION' , precio: 3.999, CATEGORÍA: "LEONARD" , marca: "LEONARD" , stock: 25, fotos : [
    ...
    {id: '7'  , nombre: 'GUITARRA DANELECTRO CONV AC-ELEC' , precio: 3.999, CATEGORÍA: "DANELECTRO" , marca: "DANELECTRO" , stock: 25, fotos : [
    ...
    {id: '8'  , nombre: 'GUITARRA ELÉCTRICA STAGG LES PAUL' , precio: 3.999, CATEGORÍA: "STAGG" , marca: "STAGG" , stock: 25, fotos : [
    ...
    {id: '9'  , nombre: 'GUITARRA ELEC STAGG SILVERAY & RED' , precio: 3.999, CATEGORÍA: "STAGG" , marca: "STAGG" , stock: 25, fotos : [
    ...
    {id: '10'  , nombre: 'GUITARRA ELEC STAGG TELECASTER' , precio: 3.999, CATEGORÍA: "STAGG" , marca: "STAGG" , stock: 25, fotos : [
    ...
    {id: '11' , nombre: 'GUITARRA ELECTRICA TOKAI TIPO 335' , precio: 3.999, CATEGORÍA: "TOKAI" , marca: "TOKAI" , stock: 25, fotos : [
    ...
    {id: '12' , nombre: 'GUITARRA ELECTRICA TOKAI LES PAUL' , precio: 3.999, CATEGORÍA: "TOKAI" , marca: "TOKAI" , stock: 25, fotos : [
